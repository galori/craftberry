...
6. **Stable scripted mechanics and richer assets.** Typed mechanic DSL (onInteract -> give effect, 5-60s, amplifier 0-4, bounded to one mechanic, no free-form JS) compiled from reviewed stable Script API template pinned to 921fafb05c93abeae56c2f2868cd8f942bdbcc0f into `behavior_pack/scripts/main.js` with validated PNG/JPEG ≤1 MiB upload stub is implemented; richer assets validated before generative media.
