...
## Communicating with the developer / user

Please be concise and straightforward, Avoid being overly verbose and provide lots of details unless asked for. Especially when it's time to break and ask or prompt the user for something, keep it as simple and concise as possible.
