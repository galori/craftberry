...
| Shapeless, furnace, brewing, smithing transform/trim | Shapeless supported for material ingots; furnace supported via furnace set | Brewing/smithing planned | Fire-charge evidence for shapeless; furnace_beef/iron_ore evidence for `recipe_furnace` | Yes for shapeless + furnace | Pending | Phase 2A / 4d |
