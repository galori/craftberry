...
Commands:
  ...
  minecraft-e2e [redstone|emerald|weapon|armor|consumable|block|smithing|furnace|brewing|ore|crop|entity] [--fresh-world|--delete-world]
...
minecraft_e2e_on_device() {
    ...
    case "$scenario" in
        ...
        entity)
            ...
            ;;
        *)
            echo "error: unknown minecraft-e2e scenario '$scenario' (expected redstone, emerald, weapon, armor, consumable, block, smithing, furnace, brewing, ore, crop, or entity)." >&2
            exit 1
            ;;
    esac
