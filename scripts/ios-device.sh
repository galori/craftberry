...
Commands:
  ...
  minecraft-e2e [redstone|emerald|weapon|armor|consumable] [--fresh-world|--delete-world]
  ...
  minecraft-e2e-all [--fresh-world]
          Run all five scenarios (redstone, emerald, weapon, armor, consumable)
...
minecraft_e2e_on_device() {
    ...
    case "$scenario" in
        ...
        consumable)
            ...
            ;;
        *)
            echo "error: unknown minecraft-e2e scenario '$scenario' (expected redstone, emerald, weapon, armor, or consumable)." >&2
            exit 1
            ;;
    esac
...
minecraft_e2e_all_on_device() {
    ...
    local scenarios=(redstone emerald weapon armor consumable)
