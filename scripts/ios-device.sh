...
Commands:
  ...
  minecraft-e2e [redstone|emerald|weapon|armor] [--fresh-world|--delete-world]
  ...
  minecraft-e2e-all [--fresh-world]
          Run all four scenarios (redstone, emerald, weapon, armor)
...
minecraft_e2e_all_on_device() {
    ...
    local scenarios=(redstone emerald weapon armor)
