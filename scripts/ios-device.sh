...
Commands:
  ...
  minecraft-e2e [redstone|emerald|weapon|armor|consumable|block] [--fresh-world|--delete-world]
  ...
  minecraft-e2e-all [--fresh-world]
          Run all six scenarios (redstone, emerald, weapon, armor, consumable, block)
...
minecraft_e2e_on_device() {
    ...
    case "$scenario" in
        ...
        block)
            ...
            ;;
        *)
            echo "error: unknown minecraft-e2e scenario '$scenario' (expected redstone, emerald, weapon, armor, consumable, or block)." >&2
            exit 1
            ;;
    esac
...
minecraft_e2e_all_on_device() {
    ...
    local scenarios=(redstone emerald weapon armor consumable block)
