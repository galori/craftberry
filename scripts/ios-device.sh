...
Commands:
  ...
  minecraft-e2e [redstone|emerald|weapon|armor|consumable|block|smithing] [--fresh-world|--delete-world]
  ...
  minecraft-e2e-all [--fresh-world]
          Run all seven scenarios (redstone, emerald, weapon, armor, consumable, block, smithing)
...
minecraft_e2e_on_device() {
    ...
    case "$scenario" in
        ...
        smithing)
            ...
            ;;
        *)
            echo "error: unknown minecraft-e2e scenario '$scenario' (expected redstone, emerald, weapon, armor, consumable, block, or smithing)." >&2
            exit 1
            ;;
    esac
...
minecraft_e2e_all_on_device() {
    ...
    local scenarios=(redstone emerald weapon armor consumable block smithing)
